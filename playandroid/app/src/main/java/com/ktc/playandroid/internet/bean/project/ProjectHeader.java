...
public class ProjectHeader {
    ...
    private int size;
    private int total;
    private List<ProjectEssayData> datas;

    public static ProjectHeader objectFromData(String str) {

        return new Gson().fromJson(str, ProjectHeader.class);
    }
    ...
    public List<ProjectEssayData> getDatas() {
        return datas;
    }

    public void setDatas(List<ProjectEssayData> datas) {
        this.datas = datas;
    }
